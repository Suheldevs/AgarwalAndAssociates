      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <a
              href="https://ssgs-admin.netlify.app"
              target="_blank"
              className=" block hover:underline cursor-pointer underline-offset-2 hover:tracking-wide"
            >
              <ChevronRight className="inline-block " />
        ...
        <div>
          ...
          <div className="space-y-4">
            {Array.isArray(blogData) && blogData.length > 0  && blogData?.slice(2,4)?.map((blog ,i)=>(
                 <Link key={i} to={`/blog/${blog.slug}`} className="flex items-start space-x-3 group cursor-pointer">
                 <img
                   src={blog.imageUrl}
                   alt="news"
                 ...
                 />
                 <div>
                   <p className="text-sm text-gray-400">{formattedDate(blog.updatedAt)}</p>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <a href="tel:7499666661" target="_blank"  className="flex items-center space-x-3">
              <Phone size={18} /> <span>+91-7499666661</span>
            </a>
            <a href="mailto:sgssandassociates@gmail.com"  target="_blank" className="flex items-center space-x-3">
              <Mail size={18} /> <span>sgssandassociates@gmail.com</span>
            </a>
            <a  href="https://maps.app.goo.gl/VXkYGdK97YTe3Xvq5" target="_blank"  className="flex items-center space-x-3">
              <MapPin size={18} /> <span>F-141, Indralok colony, Krishna Nagar, Lucknow, Uttar Pradesh</span>
            </a>
            <li>
