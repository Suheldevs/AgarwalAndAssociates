              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1 opacity-90">
                    Agarwal Tower, 42 Architectural Avenue,<br />
...
<option value="urban-planning">Urban Planning</option>
                ...
                <div>
                  ...
                  >
                    Send Message
                    <span className={`ml-2 transition-all duration-300 ${isHovered ? 'translate-x-1' : ''}`}>
                      <Send size={18} />
                    </span>
                  </button>
                </div>
          ...
          <div className="md:flex items-center justify-between">
            <div className="mb-6 md:mb-0 md:mr-8">
              ...
              <p className="text-gray-600 max-w-2xl">
                Interested in discussing your project in person? Our team of expert architects is available 
                for one-on-one consultations to explore your vision.
              </p>
            </div>
