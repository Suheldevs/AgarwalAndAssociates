...
export default function BlogDetail() {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Back Button */}
      <Link to="/blog" className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium mb-6 group transition-all">
      ...
      {/* Blog Header */}
      <div className="mb-10">
        <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">{blog.category}</span>
      ...
      <div className="mt-24">
        <div className="flex justify-between items-center mb-10">
          ...
          <Link to="/blog" className="flex items-center text-blue-600 hover:text-blue-800 font-medium group">
            View all 
          ...
          {relatedBlogs.map((article) => (
            <div key={article.id} className="group">
              <Link to={`/blog-detail/${article.slug}`} className="block">
                ...
                <h3 className="font-bold text-xl mt-2 group-hover:text-blue-600 transition-colors">{article.title}</h3>
              </Link>
