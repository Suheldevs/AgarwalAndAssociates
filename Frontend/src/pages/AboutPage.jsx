      ...
      <section ref={sectionRef} id="about" className="py-12 bg-gray-50 overflow-hidden">
        <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center px-8 md:px-16">
              <div className="max-w-2xl">
                <h2 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white transition-all duration-700 delay-200 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-6'}`}>
                  A Legacy of <span className="text-yellow-400">Architectural</span> Excellence
                </h2>
                ...
                <div className="md:w-1/3 bg-gray-900 text-white p-8 space-y-4">
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`w-10 h-10 rounded-full ${activeTab === "vision" ? "bg-gray-900" : "bg-yellow-400/20"} flex items-center justify-center mr-4`}>
                        <Building size={18} className={activeTab === "vision" ? "text-yellow-400" : "text-yellow-400"} />
                      </div>
                  ...
                  <button 
                    ...
                    className={`w-full text-left py-5 px-6 rounded-xl transition-all flex items-center justify-between ${activeTab === "mission" ? "bg-yellow-400 text-gray-900 shadow-lg" : "hover:bg-gray-800"}`}
                  >
                    <div className="flex items-center">
                      <div className={`w-10 h-10 rounded-full ${activeTab === "mission" ? "bg-gray-900" : "bg-yellow-400/20"} flex items-center justify-center mr-4`}>
                        <Briefcase size={18} className={activeTab === "mission" ? "text-yellow-400" : "text-yellow-400"} />
                      </div>
                  ...
                  <button 
                    ...
                    className={`w-full text-left py-5 px-6 rounded-xl transition-all flex items-center justify-between ${activeTab === "values" ? "bg-yellow-400 text-gray-900 shadow-lg" : "hover:bg-gray-800"}`}
                  >
                    <div className="flex items-center">
                      <div className={`w-10 h-10 rounded-full ${activeTab === "values" ? "bg-gray-900" : "bg-yellow-400/20"} flex items-center justify-center mr-4`}>
                        <Award size={18} className={activeTab === "values" ? "text-yellow-400" : "text-yellow-400"} />
                      </div>
                ...
                <div className="md:w-2/3 p-6 relative min-h-[410px]">
                  <div className={`absolute inset-0 p-10 lg:p-12 transition-all duration-500 ${activeTab === "vision" ? "opacity-100 z-10" : "opacity-0 z-0"}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                      <div className="flex items-center p-5 bg-yellow-50 rounded-xl border border-yellow-100">
                        <div className="w-12 h-12 rounded-full bg-yellow-100 flex items-center justify-center mr-4 shrink-0">
                  ...
                  <div className={`absolute inset-0 p-6 transition-all duration-500 ${activeTab === "mission" ? "opacity-100 z-10" : "opacity-0 z-0"}`}>
                    ...
                    <div className="space-y-4 text-gray-600">
                      <div className="flex items-start p-4 bg-yellow-50 rounded-xl border border-yellow-100">
                        <div className="mr-4 mt-1 text-yellow-500 shrink-0">
                          <Plus size={18} className="bg-yellow-200 rounded-full p-1" />
                        </div>
              ...
              <div className="lg:w-3/5 p-8 lg:p-12 flex flex-col justify-center">
                <div className="mb-8">
                  <div className="relative pl-6 border-l-4 border-yellow-400 py-2">
                    ...
                    <p className="text-lg text-gray-600 italic leading-relaxed bg-yellow-50 p-6 rounded-lg">
                      {coreTeam[0].quote}
                    </p>
                  </div>
                </div>
              ...
              {coreTeam.map((member, index) => (
                <div key={index} className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-yellow-500/90 via-yellow-600/70 to-transparent opacity-0 group-hover:opacity-95 transition-opacity duration-500 z-10 flex flex-col justify-end p-6">
                ...
                {milestones.map((milestone, index) => (
                  ...
                  >
                    ...
                    <div className="md:w-2/12 w-full flex justify-center relative order-first md:order-none mb-6 md:mb-0">
                      <div className="w-14 h-14 rounded-full bg-yellow-400 border-4 border-white shadow-xl flex items-center justify-center z-10 transition-transform hover:scale-110 hover:rotate-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center group">
                    ...
                    <h4 className="text-5xl font-bold text-white mb-3 group-hover:text-yellow-400 transition-colors">{stat.value}</h4>
          ...
          {/* <div className={`mt-24 transition-all duration-1000 delay-1400 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            <div className="bg-yellow-50 rounded-2xl p-12 relative overflow-hidden shadow-lg">
              <div className="absolute right-0 top-0 w-1/3 h-full opacity-10">
                <Building size={300} className="text-yellow-500 absolute -right-20 -top-20 transform rotate-12" />
              </div>
