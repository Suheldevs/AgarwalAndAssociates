...
export default function ProjectDetail() {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Back Button */}
      <Link to="/projects" className="inline-flex items-center text-red-600 hover:text-red-800 font-medium mb-6 group transition-all">
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24">
            ...
            <div className="mt-8 flex flex-col space-y-3">
              <button onClick={() => setModalOpen(true)} className="w-full px-4 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center">
      ...
      <div className="mt-12">
        <div className="flex justify-between items-center mb-10">
          ...
          <Link to="/projects" className="flex items-center text-red-600 hover:text-red-800 font-medium group">
            View all
          ...
          {relatedProjects.map((project) => (
            <div key={project.id} className="group">
              <Link to={`/project/${project.slug}`} className="block">
                ...
                <span className="text-sm font-medium text-red-600 capitalize">{project.category}</span>
                <h3 className="font-bold text-xl mt-2 group-hover:text-red-600 transition-colors">{project.title}</h3>
              </Link>
